...
def check_room_conflict(
    ...
    """အခန်းတစ်ခုတည်းတွင် အချိန်ထပ်နေသော Meeting ရှိ/မရှိ စစ်ဆေးခြင်း (Update လုပ်စဉ် မိမိ ID ကို ချန်လှပ်ရန် exclude_meeting_id ထည့်ထားသည်)"""
    ...
    return conflicting_meeting is not None
